...
function emailValido(email){
	...
	// não pode começar nem terminar coom ponto
	// deve ter ao menos dois caracteres word (letras, número, underline)
	...
	// caracteres (terminado com um pponto), seguidos por 2 ou 3 caractetes
...
function trataDados(){
	...
	if(valido=="S")
		...
		alert("OPSS! Este e-mail já existe em nosso cadastro!");
}